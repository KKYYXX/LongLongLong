...
class Projects15(db.Model):
    ...
    gdufe = db.Column(db.Integer, default=0, comment='是否和广东财经大学结对(0=否,1=是)')
    gdpic = db.Column(db.Integer, default=0, comment='是否和广东工贸职业技术学院结对(0=否,1=是)')
...
class ProgressModel(db.Model):
    ...
    video_url = db.Column(db.String(512), comment='用户上传的视频url')
